...
export default function SubscriptionList({ searching = false, pendingList = [], setInfo, reviewedList = [], searchWord = "" }: iAccountList) {
  ...
  return (
    <MyCard>
      ...
      <div className='modeName'>
        ...
        >
          <>
            <div className="closebtn" onClick={() => setShowDetails(false)}>x</div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-1 gap-4 fullwidt">
